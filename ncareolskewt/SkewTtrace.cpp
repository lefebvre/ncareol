...
SkewTtrace::SkewTtrace(SkewTAdapter& adapter, double xmin, double xmax,
                       double ymin, double ymax, double tmin, double tmax,
                       double pmin, double pmax, double tSlope,
                       std::vector<double> pres, std::vector<double> t,
...
//////////////////////////////////////////////////////////////////////
void SkewTtrace::drawTdry(double pres, double tdry) { addTdry(tdry, pres); }

//////////////////////////////////////////////////////////////////////
void SkewTtrace::drawDp(double pres, double dp) { addDp(dp, pres); }
