...
//////////////////////////////////////////////////////////////////////
SkewT::SkewT(SkewTAdapter& adapter, int n, double* pTdry, double* pDP,
             double* pWspd, double* pWdir, double* pPres, int nWindBarbs,
             std::string title, std::string subTitle, std::string credit,
...
/////////////////////////////////////////////////////////////////////////////
SkewT::~SkewT() { destroyRects(); }

/////////////////////////////////////////////////////////////////////////////
void SkewT::drawTdry(double pres, double tdry)
{
  if (pres == -999.0 || tdry == -999.0) return;
...
{
  if (pres == -999.0 || wspd == -999.0 || wspd == -999.0) return;
...
/////////////////////////////////////////////////////////////////////////////
void SkewT::maximize() { m_adapter.maximize(); }
...
/////////////////////////////////////////////////////////////////////////////
void SkewT::resize() { brandNewPlot(); }
...
void SkewT::createRects()
{
  ...
  m_isoTherms =
      new IsoTherms(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                    m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope);

  m_adiabats =
      new Adiabats(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                   m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope);

  m_isoPress =
      new IsoPress(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                   m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope);

  m_padiabats =
      new PAdiabats(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                    m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope);

  m_isoMR = new IsoMR(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                      m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope);

  m_tdryTrace =
      new SkewTtrace(m_adapter, m_thermoPageXmin, m_thermoPageXmax, m_pageYmin,
                     m_pageYmax, m_tmin, m_tmax, m_pmin, m_pmax, m_tSlope,
  ...
  m_windBarbs = new WindBarbs(m_adapter, m_windsPageXmin, m_windsPageXmax,
                              m_pageYmin, m_pageYmax, m_pmin, m_pmax,
...
/////////////////////////////////////////////////////////////////////////////
void SkewT::print() { m_adapter.print(); }
