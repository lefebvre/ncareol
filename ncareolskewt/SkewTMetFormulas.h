...
#if !defined( \
    AFX_SkewTMetFormulas_H__1A3C4A41_3DDA_11D3_BE80_00C04FA30B92__INCLUDED_)
...
{
/**
 * SkewTMetFormulas provides meteorlogical formulas for use in the SkewT
 * package. This class was created and added to the SkewT package so that SkewT
 * could be distributed without dependency on a seperate package of formulas.
 */
