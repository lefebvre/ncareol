 ...
 * actually add any isopleth specific functionality, but it is available if
 * needed. Besides, it provides a nice delineation on the class diagrams.
 */
class IsoPleth : public SkewTRect
{
 public:
   ...
   * screen units).
   */
  IsoPleth(SkewTAdapter& adapter, double xmin, double xmax, double ymin,
