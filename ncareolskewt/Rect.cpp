...
Rect::Rect(SkewTAdapter& adapter, double xmin, double xmax, double ymin,
           double ymax)
    : m_adapter(adapter)
    , m_pageXmin(xmin)
    , m_pageYmax(ymax)
...
//////////////////////////////////////////////////////////////////////
void Rect::drawLine(Rect::line l, unsigned int color, Rect::LineType lineType,
                    bool doClip)
{
  bool drawIt = 1;
  if (doClip) drawIt = clip(l);
...
{
  return (code.c1 == 0 && code.c2 == 0 && code.c3 == 0 && code.c4 == 0 &&
          o.code.c1 == 0 && o.code.c2 == 0 && o.code.c3 == 0 && o.code.c4 == 0);
}

//////////////////////////////////////////////////////////////////////
bool Rect::outcode::reject(Rect::outcode& o)
{
  return ((code.c1 && o.code.c1) || (code.c2 && o.code.c2) ||
          (code.c3 && o.code.c3) || (code.c4 && o.code.c4));
}

//////////////////////////////////////////////////////////////////////
bool Rect::outcode::OR() { return (code.c1 || code.c2 || code.c3 || code.c4); }

//////////////////////////////////////////////////////////////////////
void Rect::convertToPage(point& p)
{
  p.x = (p.x - m_xmin) * (m_pageXmax - m_pageXmin) / (m_xmax - m_xmin) +
        m_pageXmin;
  p.y = (p.y - m_ymin) * (m_pageYmax - m_pageYmin) / (m_ymax - m_ymin) +
        m_pageYmin;
}
...
//////////////////////////////////////////////////////////////////////
void Rect::resetFirstP1() { m_haveFirstP1 = 0; }
...
//////////////////////////////////////////////////////////////////////
void Rect::resetLastP2() { m_haveLastP2 = 0; }
...
void Rect::symbol(Rect::point pp, unsigned int color, SymType st)
{
  ...
  if (pp.x >= m_xmin && pp.x <= m_xmax && pp.y >= m_ymin && pp.y <= m_ymax)
  {
    convertToPage(pp);
...
double Rect::aspectRatio()
{
  double rectAspectRatio =
      (m_pageYmax - m_pageYmin) / (m_pageXmax - m_pageXmin);
