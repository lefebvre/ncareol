...
{
/**
 * WindBarb draws a standard meteorlogical wind barb, representing the speed and
 * direction of the wind. The barb points towards the direction the wind is
 * coming from. Flags on the barb cummulatively add to the wind speed: 1/2 line
 * is 5, a whole line is 10, and a triangle is 50. No assumption is made about
 * the units of the wind speed.
 */
class WindBarb
{
 public:
 ...
 protected:
  /**
   * Calculate the position of an endpoint at a given legth and direction from a
   * starting point. The aspect ratio of the Rect is taken into consideration,
   * so that the direction is validly portrayed.
