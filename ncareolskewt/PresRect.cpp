...
PresRect::PresRect(SkewTAdapter& adapter, double xmin, double xmax, double ymin,
                   double ymax, double pmin, double pmax)
...
//////////////////////////////////////////////////////////////////////
double PresRect::p(double y) { return m_pmax * pow(10.0, y * m_pRatio); }

//////////////////////////////////////////////////////////////////////
double PresRect::y(double p) { return log10(p / m_pmax) / m_pRatio; }
