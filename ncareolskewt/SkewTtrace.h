...
{
/**
 * SkewTtrace manages a collection of data points, and plots them on a
 * SkewTRect.  It also has members for plotting individual points.
 */
class SkewTtrace : public SkewTRect
{
 public:
   ...
   */
  SkewTtrace(SkewTAdapter& adapter, double xmin, double xmax, double ymin,
             double ymax, double tmin, double tmax, double pmin, double pmax,
             double tSlope, std::vector<double> pres, std::vector<double> t,
 ...
 protected:
  std::vector<double> m_pres;  ///< Vector of pressures.
  std::vector<double> m_t;     ///< Vector of temperatures.
