...
SkewTRect::SkewTRect(SkewTAdapter &adapter, double xmin, double xmax,
...
//////////////////////////////////////////////////////////////////////
void SkewTRect::drawLine(double t1, double p1, double t2, double p2,
                         unsigned int color, LineType lineType)
{
  double y1 = y(p1);
  double x1 = x(t1, y1);
  double y2 = y(p2);
