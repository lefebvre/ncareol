...
#include "ncareolskewt/SkewTAdapterSVG.h"
...
SkewTAdapterSVG::SkewTAdapterSVG(std::ostream &file, int height, int width,
                                 int symbolSize)
    : _firstLineCall(true)
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::line(double x1, double y1, double x2, double y2,
                           ...
                           SkewTAdapter::LineType lineType)
{
  ...
  else
  {
    if ((_lastX2 != x1) || (_lastY2 != y1) || colorCode != _lastColorCode)
    {
      ...
      SkewTSVGPolyline *pl =
          new SkewTSVGPolyline(_xvals, _yvals, _width, _height, colorCode);
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::Text(const std::string &s, const double x, const double y,
                           unsigned int colorCode)
{
  if (s.size() == 0) return;
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::setSkewT(SkewT *pSkewT) { _pSkewT = pSkewT; }

//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::addTdry(double x, double y)
{
  // create the datum
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::addDp(double x, double y)
{
  // create the datum
...
void SkewTAdapterSVG::drawElements()
{
  ...
  SkewTSVGText subTitle(_subTitle, 0.5, 0.93, w, h, SkewTSVGText::AlignHCenter,
                        SKEWT_BLUE, 1.25);
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::unzoom() { init(); }

//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::extents(double &xmin, double &xmax, double &ymin,
                              double &ymax)
{
  xmin = 0;
  ymin = 0;
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::symbol(double x, double y, unsigned int colorCode,
                             SymType st)
{
  // create the datum
...
void SkewTAdapterSVG::title(std::string s)
{
  ...
  SkewTSVGText title(s, 0.50, 0.98, _width, _height, SkewTSVGText::AlignCenter,
                     SKEWT_BLUE);
}
...
{
  _subTitle = s;
  SkewTSVGText subTitle(s, 0.50, 0.94, _width, _height,
                        SkewTSVGText::AlignCenter, SKEWT_BLUE);
}
...
//////////////////////////////////////////////////////////////////////
void SkewTAdapterSVG::savePlot(std::string path, int xPixels, int yPixels,
...
//////////////////////////////////////////////////////////////////////
SkewTSVGPolyline::SkewTSVGPolyline(std::vector<double> x, std::vector<double> y,
                                   int w, int h, unsigned int colorCode)
    : _x(x)
    , _y(y)
    , _w(w)
    , _h(h)
...
std::string SkewTSVGPolyline::draw()
{
  ...
  result += "\"\n";
  result +=
      "stroke=\"" + color() + "\" stroke-width=\"0.5\" fill=\"none\" />\n";

  return result;
}
//////////////////////////////////////////////////////////////////////
std::string SkewTSVGPolyline::color() { return _colorName; }
//////////////////////////////////////////////////////////////////////
SkewTSVGText::SkewTSVGText(std::string text, double x, double y, int w, int h,
                           SkewTSVGText::AlignType alignFlag,
                           unsigned int colorCode, double fontScale)
    : _text(text)
    , _x(x)
    , _y(y)
    , _w(w)
...
std::string SkewTSVGText::draw()
{
  ...
  if (_alignFlag & SkewTSVGText::AlignRight) anchor = " text-anchor=\"right\" ";
...
//////////////////////////////////////////////////////////////////////
std::string SkewTSVGText::color() { return _colorName; }
//////////////////////////////////////////////////////////////////////
SkewTSVGDatum::SkewTSVGDatum(double x, double y, int w, int h, int size,
                             unsigned int colorCode)
    : _x(x)
    , _y(y)
    , _w(w)
...
//////////////////////////////////////////////////////////////////////
std::string SkewTSVGDatum::color() { return _colorName; }
